...
function [model_output] = associability_model(params, rewards, choices)
    ...
    for t = 1:T
        ...
        % Update the associability estimate, as per below (equations 6 and
    ...
    model_output.expected_value = expected_reward;
    model_output.P = P;
